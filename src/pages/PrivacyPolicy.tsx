        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <section className="mb-10">
              ...
              <p>
                Welcome to EllowDigital ("we," "our," or "us"). We are committed to protecting your privacy and providing you with a safe experience when using our services. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
              </p>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">2. Information We Collect</h2>
              ...
              <p>
                We collect this information using cookies, web beacons, and similar technologies.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">3. How We Use Your Information</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">4. Cookies and Other Tracking Technologies</h2>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">5. Data Sharing and Disclosure</h2>
              <p>We may share your information in the following situations:</p>
              <ul className="list-disc pl-6 mb-4">
                <li><strong>With service providers:</strong> We may share your information with third-party vendors, consultants, and other service providers who need access to your information to perform services on our behalf.</li>
                <li><strong>Business transfers:</strong> If we are involved in a merger, acquisition, or sale of all or a portion of our assets, your information may be transferred as part of that transaction.</li>
                <li><strong>Legal requirements:</strong> We may disclose your information if required to do so by law or in response to valid requests by public authorities.</li>
                <li><strong>To protect rights:</strong> We may disclose your information to protect the rights, property, or safety of EllowDigital, our customers, or others.</li>
                <li><strong>With your consent:</strong> We may share your information with your consent or at your direction.</li>
              </ul>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">6. Data Security</h2>
              <p>
                We implement appropriate security measures to protect the security of your personal information. However, please note that no method of transmission over the Internet or method of electronic storage is 100% secure.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">7. Your Data Protection Rights</h2>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">8. Children's Privacy</h2>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">9. Changes to This Privacy Policy</h2>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-brand-yellow mb-4">10. Contact Us</h2>
              <p>

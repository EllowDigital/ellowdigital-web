...
const models = [
  {
    ...
    features: ["Defined deliverables", "Predictable cost", "Milestone-based payments"]
  },
  {
    icon: Clock,
    title: "Hourly Rate",
    description: "Ideal for ongoing development and flexible projects",
    features: ["Maximum flexibility", "Transparent billing", "Scale up or down as needed"]
  },
  {
    icon: Users,
    title: "Dedicated Team",
    description: "For long-term partnerships and complex projects",
    features: ["Consistent team allocation", "Deep product knowledge", "Enhanced productivity"]
  },
  {
    icon: DollarSign,

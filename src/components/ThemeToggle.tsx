    ...
    <HoverCard>
      <HoverCardTrigger asChild>
        <Button 
          ...
          className="rounded-full relative overflow-hidden button-3d bg-card border border-border shadow-md"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-brand-gold/10 to-brand-yellow/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

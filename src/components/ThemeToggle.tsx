    ...
    <HoverCard>
      <HoverCardTrigger asChild>
        <Button 
          ...
          className="rounded-full relative overflow-hidden button-3d bg-background border border-border"
        >
      ...
      <HoverCardContent side="bottom" className="w-auto glass-effect">

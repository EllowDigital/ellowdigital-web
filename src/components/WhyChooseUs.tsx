      ...
      <div className="section-container max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-brand-yellow/10 backdrop-blur-sm border border-brand-yellow/30 rounded-full">
              ...
              <span className="text-xs text-brand-yellow font-medium">Industry-Recognized Excellence</span>
            </div>
          </motion.div>
          ...
          >
            {reasons.map((reason, index) => (
              ...
              >
                ...
                <div className={`relative w-14 h-14 rounded-full bg-gradient-to-br ${reason.color} flex items-center justify-center mb-5 sm:mb-6 transform transition-all duration-300 group-hover:scale-110 overflow-hidden`}>
        ...
        >
          ...
          <div className="text-center md:text-left relative z-10">
            <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-black drop-shadow-sm">Ready to elevate your digital presence?</h3>

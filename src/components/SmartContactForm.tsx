...
const SmartContactForm = () => {
  ...
  return (
    <section id="contact" className="section-container py-24 relative overflow-hidden snap-start">
      {/* Background blobs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <form 
              ...
              className="space-y-6 neo-effect p-8 rounded-xl reveal-animate card-3d tilt-effect"
            >
              ...
              <div className="float-label-input">
                <textarea
                  ...
                  placeholder=" "
                  required
                  className="resize-none neo-effect"
                ></textarea>
                ...
                className={`w-full py-3 flex items-center justify-center transition-all ${
                  formStatus === "success" 
                    ...
                    : formStatus === "error"
                      ...
                      : "bg-brand-yellow text-black hover:bg-brand-gold"
                }`}
              >
                {formStatus === "idle" && (
                  <>
            ...
            <div className="glass-effect p-8 rounded-xl h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-brand-yellow/10 flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-8 h-8 rounded-full bg-brand-yellow/10 flex items-center justify-center text-brand-yellow hover:bg-brand-yellow hover:text-black transition-colors">
